...
- Generate professional-grade video summaries and highlight clips automatically using state-of-the-art Spatiotemporal Attention. Built for video editors, sports broadcasters, and researchers who need to distill hours of footage into impactful highlight reels. Achieve CVPR 2024-level summarization accuracy with a single command.
- **Tech Stack & Skills**: `PyTorch, Python`
- **Source**: [`Highlight-Video-CSTA`](https://github.com/quangkmhd/Highlight-Video-CSTA)
...
- **Source**: [`IQMeetRAGv2`](https://github.com/quangkmhd/IQMeetRAGv2)
...
- **Tech Stack & Skills**: `FFmpeg, Gradio, Hugging Face, PyTorch, Python`
- **Source**: [`Segment-Everything-Everywhere-All-At-Once`](https://github.com/quangkmhd/Segment-Everything-Everywhere-All-At-Once)
...
- **Tech Stack & Skills**: `Computer Vision, JavaScript, LLM, React, Three.js, Vite`
- **Source**: [`portfolio_quang`](https://github.com/quangkmhd/portfolio_quang)
