...
### 📂 InsureVN - Multi-Agent AI Platform for Vietnamese Health Insurance
...
- **Tech Stack & Skills**: `FastAPI, Knowledge Graph, LangChain, Langfuse, MCP/FastMCP, Multi-Agent Systems, Neo4j, NetworkX, Python, PyTorch/CUDA, Qdrant, RAG, SQLite`
- **Source**: [`InsureVN`](https://github.com/quangkmhd/InsureVN)

### 📂 IQMeet — AI-Powered Vietnamese Meeting Intelligence System

- An all-in-one AI Meeting Assistant tailored for the Vietnamese language and workplace. It automates the entire meeting lifecycle—from real-time transcription and speaker diarization to AI-powered summarization and action item extraction. It features a RAG-based knowledge base that transforms transcripts and uploaded documents (PDF/Word) into a searchable intelligence hub, enabling users to query meeting history and cross-reference data with high precision.
- **Tech Stack & Skills**: `Docker, FastAPI, Gemini, Next.js, Node.js, PostgreSQL/pgvector, Python, RAG, React, Supabase, Tailwind CSS`
- **Source**: [`IQMEET-Meeting-Intelligence-Assistant`](https://github.com/quangkmhd/IQMEET-Meeting-Intelligence-Assistant)

### 📂 IMA: Intelligent Meeting Assistance Agent RAG
...
- **Tech Stack & Skills**: `Docker, FastAPI, LLM, LangChain, Neo4j, Python, Qdrant`
- **Source**: [`IMA-Assistance-Agent-RAG`](https://github.com/quangkmhd/IMA-Assistance-Agent-RAG)
...
- **Tech Stack & Skills**: `Docker, FastAPI, LangChain, Neo4j, Python, Qdrant, RAG`
- **Source**: [`iqmeet-agentic-rag`](https://github.com/quangkmhd/iqmeet-agentic-rag)
...
- **Tech Stack & Skills**: `FastAPI, Python`
- **Source**: [`gworkspace-ai-agent`](https://github.com/quangkmhd/gworkspace-ai-agent)
...
- **Tech Stack & Skills**: `Accelerate, Hugging Face, LLM, LanceDB, PyMuPDF, PyTorch, Python, RAG, SentenceTransformers, Transformers`
- **Source**: [`Askly`](https://github.com/quangkmhd/Askly)
...
- **Tech Stack & Skills**: `Flask, Groq, LLM, LanceDB, PyTorch, Python, RAG, Streamlit`
- **Source**: [`Chatbot_mentalhealth_cat-dog`](https://github.com/quangkmhd/Chatbot_mentalhealth_cat-dog)
...
- **Tech Stack & Skills**: `Flask, Groq, LLM, LanceDB, PyTorch, Python, RAG, SentenceTransformers`
- **Source**: [`pet-health-assistant`](https://github.com/quangkmhd/pet-health-assistant)
...
- **Tech Stack & Skills**: `Docker, Gradio, Hugging Face, Python, Transformers, vLLM`
- **Source**: [`Qwen3-ASR-VI`](https://github.com/quangkmhd/Qwen3-ASR-VI)
...
- **Tech Stack & Skills**: `Docker, FFmpeg, PyTorch, Python`
- **Source**: [`VoiceWeaver`](https://github.com/quangkmhd/VoiceWeaver)
...
- **Tech Stack & Skills**: `Computer Vision, Flask, OpenCV, PyTorch, Python, YOLO`
- **Source**: [`AutoMask-Refinery`](https://github.com/quangkmhd/AutoMask-Refinery)

### 📂 Smart Logo Masker 🛡️

- This project uses YOLOv26 Segmentation to automatically detect and mask betting logos (e.g., 1xbet, melbet, etc.) in videos.
- **Tech Stack & Skills**: `Docker, FastAPI, OpenCV, Python, YOLO`
- **Source**: [`Smart-Logo-Masker`](https://github.com/quangkmhd/Smart-Logo-Masker)
...
- **Tech Stack & Skills**: `AWS, Hugging Face, PyTorch, Python, Streamlit`
- **Source**: [`yt-asr-kit`](https://github.com/quangkmhd/yt-asr-kit)
...
- **Tech Stack & Skills**: `Python, Streamlit`
- **Source**: [`Translations-with-LLaMA`](https://github.com/quangkmhd/Translations-with-LLaMA)
...
- **Tech Stack & Skills**: `Python, ML/AI`
- **Source**: [`horce_racing`](https://github.com/quangkmhd/horce_racing)
...
- **Tech Stack & Skills**: `Docker, Groq, LLM, Python, Streamlit`
- **Source**: [`ResumeEnhancer`](https://github.com/quangkmhd/ResumeEnhancer)
...
- **Tech Stack & Skills**: `GCP, JavaScript, React, TypeScript, Vite`
- **Source**: [`toeic_master`](https://github.com/quangkmhd/toeic_master)
